Module Module1
    ...
    Sub Simulation()
        ...
        Dim Response, SaveResponse As String
        Dim Year As Integer
        ...
        Console.WriteLine("Would you like to save this field? (Y/N) : ")
        SaveResponse = Console.ReadLine()
        Do Until CorrectInput = True
            If SaveResponse.ToLower() = "y" Then
                CorrectInput = True
                Console.WriteLine("Enter File Name")
                SaveField(Field)
            ElseIf SaveResponse.ToLower() = "n" Then
                CorrectInput = True
                Console.WriteLine("Field will not be saved.")
    ...
    Sub SaveField(ByRef Field)
        Dim FileName As String = Console.ReadLine() & ".txt"
        FileOpen(1, FileName, OpenMode.Output)
        For Row = 0 To FIELDLENGTH - 1
            Dim file_row As String = ""
            For Column = 0 To FIELDWIDTH - 1
                file_row &= Field(Row, Column)
            Next
            PrintLine(1, file_row & "|  " & Row)
        Next
        FileClose(1)
    End Sub
